...
export default {
    ...
    execute: async (sock, m, args, text) => {
        if (args.length < 3) {
            return m.reply(`Format salah. Gunakan: .cekbank <type> <code> <number>\n\nContoh:\n.cekbank ewallet dana 08123456789\n.cekbank bank bca 1234567890`);
        }
        ...
        try {
            ...
            console.log('CekBank Debug:', JSON.stringify(result, null, 2));
            ...
            console.error('CekBank Error:', error.response ? error.response.data : error.message);

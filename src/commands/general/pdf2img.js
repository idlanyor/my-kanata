...
export default {
    ...
    execute: async (sock, m, args) => {
        ...
        try {
            ...
            const isPdf = /pdf/.test(mime) || /documentMessage/.test(mtype) || (msg.fileName && msg.fileName.endsWith('.pdf'));
            ...
            const cleanName = (msg.fileName ? path.parse(msg.fileName).name : 'Converted').replace(/\s+/g, '_');

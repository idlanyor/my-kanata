...
import { processAiTransaction } from '../../lib/financeService.js';
    ...
    execute: async (sock, m, args, text) => {
        try {
            ...
            for (const tx of transactions) {
                ...
                const formattedAmount = new Intl.NumberFormat('id-ID', { style: 'currency', currency: 'IDR', maximumFractionDigits: 0 }).format(tx.amount);
                const txDate = new Date(tx.date).toLocaleString('id-ID', { dateStyle: 'short', timeStyle: 'short' });

export default {
    ...
    execute: async (sock, m, args, text) => {
        console.log(`[DEBUG] Executing native button command for ${m.chat}`);
        ...
        try {
            ...
            console.log(`[DEBUG] Native button message sent via core.`);
        } catch (err) {
            console.error('[ERROR] Failed to send native button:', err);

export default [
    {
        ...
        execute: async (sock, m, args, text) => {
            ...
            try {
                ...
                if (!pending || pending.length === 0) return m.reply('Gak ada permintaan join yang pending saat ini.');
                ...
                console.error(err);
                m.reply('Gagal mengambil daftar pending. Pastikan fitur "Admin Approval" aktif di grup ini.');
            }
        }
    },
    {
        ...
        execute: async (sock, m, args, text) => {
            ...
            if (!target) return m.reply('Ketik nomor HP orang yang mau di-approve!\nContoh: .approve 62812345678');
            ...
            try {
                ...
                console.error(err);
                m.reply('Gagal menyetujui permintaan. Pastikan nomor tersebut ada di daftar pending.');
            }
        }
    },
    {
        ...
        execute: async (sock, m, args, text) => {
            ...
            let target = args[0]?.replace(/[^0-9]/g, '');
            if (!target) return m.reply('Ketik nomor HP orang yang mau di-tolak!\nContoh: .reject 62812345678');

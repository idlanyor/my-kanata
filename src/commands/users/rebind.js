...
export default {
    ...
    execute: async (sock, m, args, text) => {
        ...
        if (!pnJid || !pnJid.includes('@s.whatsapp.net')) {
            return m.reply('❌ Gagal mendeteksi nomor WhatsApp asli kamu. Pastikan kamu tidak mengirim pesan dari nomor yang sama dengan bot.');
        }

...
export type AnyRegularMessageContent = (
	                        ...
	                        | ({
	                                ...
	                                footer?: string
	                                        ...
	                                        | ({
	                                                ...
	                                                | {
	                                                        list: proto.Message.IListMessage
	                                                  }
	                                                | {
	                                                        groupStatus: string | AnyMediaMessageContent
	                                                  }
	                                                | ({
	...
	| {
	        ...
	        | {
	                        ...
	                        | {
	                                        lottieSticker: string | AnyMediaMessageContent
	                          }
	                        | {
	                                        invoice: proto.Message.IInvoiceMessage
	                                                        ...
	                                                        | {
	                                                                        botInvoke: string | AnyMediaMessageContent
	                                                          }
	                                                        | {

...
export function decryptEventResponse(
	 ...
	 * @param response encrypted event edit
	 * @param ctx additional info about the event required for decryption
	 * @returns event edit message
	 */
	 ...
	 * @param response encrypted comment
	 * @param ctx additional info about the comment required for decryption
	 * @returns comment message
	 */
	export function decryptComment(
	        { encPayload, encIv }: proto.Message.IEncCommentMessage,
	        { commentCreatorJid, commentMsgId, commentEncKey, commentJid }: { commentCreatorJid: string, commentMsgId: string, commentEncKey: Uint8Array, commentJid: string }
	) {
	        const sign = Buffer.concat([
	...
	const processMessage = async (	message: WAMessage,
	{

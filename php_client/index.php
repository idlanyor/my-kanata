...
if ($_SERVER['REQUEST_METHOD'] === 'POST') {
    ...
    if ($action === 'create_manual') {
        $data = [
            ...
            'kakeiboCategory' => $_POST['kakeiboCategory'] ?: null
        ];
        ...
        <div class="card-body">
          <form method="GET" class="row">
            ...
            <div class="col-md-2 mb-2">
              ...
              <input type="text" name="category" class="form-control form-control-sm" placeholder="Cari..." value="<?php echo $filterCategory; ?>">
            </div>
            <div class="col-md-2 mb-2 d-flex align-items-end gap-1">
              ...
              <button type="button" onclick="resetFilters()" class="btn btn-default btn-sm ml-1"><i class="fas fa-sync"></i></button>
            </div>
          </form>
        </div>
      </div>
                  ...
                  <tr>
                    ...
                    <td>
                      ...
                      <form method="POST" class="d-inline" onsubmit="return confirm('Hapus?')">
                        ...
                        <input type="hidden" name="delete_id" value="<?php echo $tx['_id']; ?>">
                    ...
                    <div class="tab-pane fade show active" id="manual-form" role="tabpanel">
                        <form method="POST">
                            ...
                            <div class="form-group">
                                ...
                                <input type="number" name="amount" class="form-control" placeholder="10000" required>
                            </div>
                            <div class="form-group">
                                <label>Kategori</label>
                                <input type="text" name="category" class="form-control" placeholder="Makanan, Transportasi...">
                            </div>
                            <div class="form-group">
                                <label>Keterangan</label>
                                <input type="text" name="description" class="form-control" placeholder="Beli apa?" required>
                            </div>
                            <div class="form-group">
                    ...
                    <div class="tab-pane fade" id="ai-form" role="tabpanel">
                        <form method="POST" enctype="multipart/form-data">
                            ...
                            <div class="form-group">
                                ...
                                <textarea name="prompt" class="form-control" rows="3" placeholder="Contoh: tadi beli bakso 15rb"></textarea>
                            </div>
                            <div class="form-group">
                                <label>Lampiran (Struk/Screenshot/VN)</label>
                                <input type="file" name="file" class="form-control-file" accept="image/*,audio/*">
                            </div>

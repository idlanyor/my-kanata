      ...
      <div class="card">
        ...
        <div class="card-body p-0 table-responsive">
          <table class="table table-hover text-nowrap">
            ...
            <tbody>
              <?php if (empty($users)): ?>
                <tr><td colspan="8" class="text-center py-4">Tidak ada data user ditemukan.</td></tr>
              <?php else: ?>
                <?php foreach ($users as $u): ?>
                  <tr>
                    ...
                    <td><?php echo htmlspecialchars($u['emailCloud'] ?: '-'); ?></td>
                    ...
                    <td>
                      <button class="btn btn-info btn-sm" 
                        ...
                        data-email="<?php echo htmlspecialchars($u['emailCloud']); ?>"
                        data-phone="<?php echo htmlspecialchars($u['phoneNumber'] ?? ''); ?>">
    ...
    <div class="modal-content">
      ...
      <form method="POST">
        <div class="modal-body">
          ...
          <div class="form-group">
            <label>Email Pterodactyl</label>
            <input type="email" name="emailCloud" id="edit-email" class="form-control">
          </div>

          <div class="form-group">
            <label>Nomor WhatsApp (PN)</label>
            <input type="text" name="phoneNumber" id="edit-phone" class="form-control" placeholder="628xxx">
          </div>
        </div>
